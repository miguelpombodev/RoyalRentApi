...
namespace RoyalRent.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250827153140_ChangeFuelTypeTableNameColumnVarcharLength")]
    partial class ChangeFuelTypeTableNameColumnVarcharLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoyalRent.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Entities.PaymentStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Entities.Rent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Entities.Payment", b =>
                {
                    b.HasOne("RoyalRent.Domain.Entities.PaymentStatus", "PaymentStatus")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Entities.Rent", b =>
                {
                    b.HasOne("RoyalRent.Domain.Entities.Car", "Car")
                        .WithMany("Rents")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
