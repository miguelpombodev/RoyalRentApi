...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoyalRent.Domain.Cars.Entities.Car", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Payments.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Payments.Entities.PaymentStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
                    ...
                    b.ToTable("PaymentsStatus", (string)null);
                });

            modelBuilder.Entity("RoyalRent.Domain.Rents.Entities.Rent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
                    ...
                    b.Property<DateTime?>("PaymentAt")
                        .HasColumnType("TIMESTAMP WITH TIME ZONE")
                        .HasColumnName("paymentAt");

                    b.Property<DateTime>("RentFinishesAt")
                        .HasColumnType("TIMESTAMP WITH TIME ZONE")
                        .HasColumnName("rentFinishesAt");

                    b.Property<DateTime>("RentStartsAt")
                        .HasColumnType("TIMESTAMP WITH TIME ZONE")
                        .HasColumnName("rentStartsAt");
            ...
            modelBuilder.Entity("RoyalRent.Domain.Users.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Users.Entities.UserAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Users.Entities.UserDriverLicense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Users.Entities.UserPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("UUID")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Payments.Entities.Payment", b =>
                {
                    b.HasOne("RoyalRent.Domain.Payments.Entities.PaymentStatus", "PaymentStatus")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Rents.Entities.Rent", b =>
                {
                    b.HasOne("RoyalRent.Domain.Cars.Entities.Car", "Car")
                        .WithMany("Rents")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_RENT_CAR_ID");

                    b.HasOne("RoyalRent.Domain.Users.Entities.User", "User")
                        .WithMany("Rents")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_RENT_USER_ID");
            ...
            modelBuilder.Entity("RoyalRent.Domain.Users.Entities.UserAddress", b =>
                {
                    b.HasOne("RoyalRent.Domain.Users.Entities.User", "User")
                        .WithOne("UserAddress")
                        .HasForeignKey("RoyalRent.Domain.Users.Entities.UserAddress", "UserId")
            ...
            modelBuilder.Entity("RoyalRent.Domain.Users.Entities.UserDriverLicense", b =>
                {
                    b.HasOne("RoyalRent.Domain.Users.Entities.User", "User")
                        ...
                        .HasForeignKey("RoyalRent.Domain.Users.Entities.UserDriverLicense", "UserId")
